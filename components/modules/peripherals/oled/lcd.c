...
void lcd_show_logo(const uint8_t*  mode_str)
{
	...
	LCD_ShowChinese(TITLE_OFFSET,20,6,32,BLUE);   //家
	LCD_ShowChinese(48+TITLE_OFFSET,20,7,32,BLUE);   //庭
	LCD_ShowChinese(96+TITLE_OFFSET,20,8,32,BLUE);   //检
	LCD_ShowChinese(144+TITLE_OFFSET,20,9,32,BLUE);   //测
	LCD_ShowChinese(192+TITLE_OFFSET,20,10,32,BLUE);   //仪
/*
